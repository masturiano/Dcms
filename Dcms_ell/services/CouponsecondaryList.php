 ...
 * @version $Id$
 */
class Dcms_Service_CouponsecondaryList extends USAP_Service_ServiceAbstract {
    ...
    public function getPaginator($request) {
		...
		$hydraService['data']['sort'] = (isset($request['sortby'])) ? array($request['sortby'] => $request['sort']) : array('batch_id' => "-1"); 
