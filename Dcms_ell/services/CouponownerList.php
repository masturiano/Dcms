 ...
 * @version $Id$
 */
class Dcms_Service_CouponownerList extends USAP_Service_ServiceAbstract {
    ...
    public function getPaginator($request) {
		...
		$hydraService['data']['sort'] = (isset($request['sortby'])) ? array($request['sortby'] => $request['sort']) : array('owner' => "1"); 
