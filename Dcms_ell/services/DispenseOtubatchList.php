 ...
 * @version $Id$
 */
class Dcms_Service_DispenseOtubatchList extends USAP_Service_ServiceAbstract {
    ...
    public function getPaginator($request) {
        ...
        isset($request['sorting']) ? $hydraService['data']['sort'] = $request['sorting'] : array('coupon.name' => "1"); # Name: Del # Date Modify: May 2016
