 ...
 * 
 * @package Dcms_Service_Migrator
 * @subpackage Mysql
 * @author Faustino M. Olpindo, Jr.
 * @copyright 2012
 * @version $id$
 */
class Dcms_Service_Migrator_Mysql extends USAP_Service_ServiceAbstract {
     ...
     */
    public function __construct(Zend_Config $config, Zend_Application_Resource_Db $mysqlResource,$site) {
        $this->config = $config;
        $this->dbResource = $mysqlResourcee;
        $this->db = $mysqlResource->getDb($site);
    }
